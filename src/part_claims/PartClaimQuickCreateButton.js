...
export default props => {
    ...
    const handleSubmit = async values => {
        ...
        try {
            const { data } = await dataProvider(CREATE,'partclaims', {
                data: {...values, claim:props.claimId}
            });
            setData(data);
            setShowDialog(false);
            props.refresh()
        ...
        <>
            ...
            >
                ...
                <DialogContent>
                    ...
                    >
                        <QCSubmitExtractor>
                            <ReferenceInput label="Part" source="part" reference="parts">
                                <SelectInput optionText="name" />
                            </ReferenceInput>
                            <br/>
                            <NumberInput label="Number of parts" source="number"/>
                        </QCSubmitExtractor>
                    </SimpleForm>
                </DialogContent>
                <DialogActions>
